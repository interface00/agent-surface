...
```bash
npm install @orangestudio-npm/agent-surface
```
...
import { createNegotiator } from '@orangestudio-npm/agent-surface/negotiate';
...
```js
import { shouldServeMarkdown, classifyAgent, VARY_HEADER } from '@orangestudio-npm/agent-surface';
